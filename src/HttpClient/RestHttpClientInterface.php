...
interface RestHttpClientInterface
{
    ...
    /**
     * Perform a POST request on a REST API
     *
     * @param string $url
     * @param array $parameters
     * @param array $headers
    ...
    /**
     * Perform a PUT request on a REST API
     *
     * @param string $url
     * @param array $parameters
     * @param array $headers
    ...
    /**
     * Perform a PATCH request on a REST API
     *
     * @param string $url
     * @param array $parameters
     * @param array $headers
    ...
    /**
     * Perform a DELETE request on a REST API
     *
     * @param string $url
     * @param array $parameters
     * @param array $headers
